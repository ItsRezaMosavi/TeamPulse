    ...
    : SaveChangesInterceptor
{
    ...
    /// <list type="number">
    /// <item><description>Calls the Delete method with current user ID and timestamp</description></item>
    /// <item><description>Changes the entity state to Modified so it updates instead of deletes</description></item>
    /// </list>
