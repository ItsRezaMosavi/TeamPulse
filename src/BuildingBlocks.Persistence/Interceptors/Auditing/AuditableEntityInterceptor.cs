	...
	: SaveChangesInterceptor
{
	...
	///     <list type="bullet">
	///         <item>
	///             <description>Added entities: Calls SetCreated with current user ID and timestamp</description>
	///         </item>
	///         <item>
	///             <description>Modified entities: Calls SetUpdated with current user ID and timestamp</description>
	///         </item>
	///     </list>
