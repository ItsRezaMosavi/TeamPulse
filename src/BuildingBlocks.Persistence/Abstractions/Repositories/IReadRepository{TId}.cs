...
public interface IReadRepository<TAggregate, in TId> where TAggregate : AggregateRoot<TId>
{
	...
	Task<IReadOnlyList<TResult>> ListAsync<TResult>(IQuerySpecification<TAggregate, TResult> specification,
													CancellationToken cancellationToken = default);
	...
	Task<TResult?> SingleOrDefaultAsync<TResult>(IQuerySpecification<TAggregate, TResult> specification,
												 CancellationToken cancellationToken = default);
	...
	Task<TResult> SingleAsync<TResult>(IQuerySpecification<TAggregate, TResult> specification,
									   CancellationToken cancellationToken = default);
	...
	Task<TResult?> FirstOrDefaultAsync<TResult>(IQuerySpecification<TAggregate, TResult> specification,
												CancellationToken cancellationToken = default);
	...
	/// <exception cref="InvalidOperationException">Thrown when no element satisfies the condition.</exception>
	Task<TResult> FirstAsync<TResult>(IQuerySpecification<TAggregate, TResult> specification,
									  CancellationToken cancellationToken = default);
